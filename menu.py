...
while place_order:
    ...
    if menu_category.isdigit():
        ...
        if int(menu_category) in menu_items.keys():
            ...
            item_number = input('Please enter the number of the item you would like to order:')
            ...
            if(item_number.isnumeric()):
                ...
                print('The menu selection you made is invalid.')
        ...
        match keep_ordering.lower():
            ...
            case 'n' | 'no':
                ...
                for order in order_list:
                    print(f"{order['quantity']} x {order['item_name']} at ${order['item_price']:.2f} each")
...
for order in order_list:
    ...
    price_space = 6 - len(f"{item_price:.2f}")
